...
Markero.prototype.icon = function (options) {
	...
	skala *= 1;
	var szerokosc = 22 * skala;
	var szerokosc = Math.ceil(szerokosc);
	var wysokosc = 37 * skala;
	var wysokosc = Math.ceil(wysokosc);
...
boxText.innerHTML = "<div style='background-color:white;'>&nbsp;</div>";
InfoBox.myOptions = {
	content: boxText,
