...
(function() {
	...
	RichMarker.prototype.startDrag = function(e) {
		...
		if (!this.dragging_) {
			this.dragging_ = true;
			var map = this.getMap();
			this.mapDraggable_ = impet.map.get('draggable');
			impet.map.set('draggable', false);
...
boxText.innerHTML = "Marker do okrozycji<br><b>ale potrafi wiecej<b><br>" +
	"<a href=\"http://impet.eu\" tartget='_blank'>Na pr<h1>Nora</h1></a>" +
	"<table border=1 style='border-collaplse:collapse;'><thead><tr><th>Kolumna</th><th>druga</th></tr></thead><tbody><tr><td></td>Pierwsza cela<td>No i druga</td></tr></tbody>";
...
//boxText.innerHTML="Marker do okreslania pozycji<br><b>ale potrafi wiecej<b><br><a href=\"http://impet.eu\" tartget='_blank'>Na przykd<h1>Nora</h1></a><table border=1 style='border-collaplse:collapse;'><thead><tr><th>Kolumna</th><th>druga</th></tr></thead><tbody><tr><td></td>Pierwsza cela<td>No i druga</td></tr></tbody>"

	function utworzEtykieteNaMapie(map, tresc, position) {
		var myOptions = {
			...
			position: position || impet.map.getCenter(),
			closeBoxURL: "",
			isHidden: false,
			pane: "mapPane",
